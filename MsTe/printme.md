...
```csharp
    public static class Extensions
    {
        ...
        // TODO: HsrWhere
        public static IEnumerable<TSource> HsrWhere<TSource>(this IEnumerable<TSource> source,
...
```csharp
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                new Employee { Name = "Michael", Address = "SW ..ane", State = "WA", Salary = 5675, DepId = 1},
                new Employee { Name = "Jennifer", Address = "1245 ..Dr", State = "OR", Salary = 6555, DepId = 1},
                new Employee { Name = "Sean", Address = "55217...te Dr", State = "WA", Salary = 8888, DepId = 1},
            ...
            var empQuery = employees
                .Join(departments, eKey => eKey.DepId, dKey => dKey.Id, (e, d) => new {
                    EmployeeName = e.Name, DepartmentName = d.Name
                })
            ...
            empQuery.ForEach(c => {
                Console.WriteLine("Name: {0}, Department: {1}", c.EmployeeName, c.DepartmentName)
            });
            ...
            var maxDeptSalary = departments
                .GroupJoin(employees, dKey => dKey.Id, eKey => eKey.DepId, (d, e) => new {
                    DepartmentName = d.Name, MaxSalary = e.Max(eg => eg.Salary) })
            ...
            projStatistics.ForEach(p => {
                 Console.WriteLine("Project {0} Mgr {1} Number Employees {2} Average Salary {3}",
                                   p.Project, p.Mgr, p.EmpCount, p.AvgSalary)});
